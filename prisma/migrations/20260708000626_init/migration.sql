-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('ADMIN', 'CLIENT');

-- CreateEnum
CREATE TYPE "AddressType" AS ENUM ('SHIPPING', 'BILLING');

-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('CASH', 'BANK_TRANSFER', 'CREDIT_CARD', 'DEBIT_CARD', 'MERCADO_PAGO', 'OTHER');
...
-- CreateEnum
CREATE TYPE "StockMovementType" AS ENUM ('INITIAL', 'PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'RESERVATION', 'RELEASE');
...
-- CreateIndex
CREATE INDEX "Stock_reservedQuantity_idx" ON "Stock"("reservedQuantity");
